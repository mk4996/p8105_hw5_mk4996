...
* **Comment**
The plot shows how power increases as the true mean (µ) moves away from zero. When µ=0, power is approximately 0.05, matching the significance level (alpha=0.05).
...
We created `city_state` (e.g., “Baltimore, MD”) and summarized within cities to obtain
