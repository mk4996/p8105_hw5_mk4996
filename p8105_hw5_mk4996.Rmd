...
Chicago, IL had the highest total number of homicides (`r format(chi_total, big.mark=",")`) and one of the highest proportions of unsolved cases (`r chi_prop`%), followed by New Orleans, LA (`r nola_prop`%) and Baltimore, MD (`r bal_prop`%). 
